...
metaDescription: "A marketing plan makes use of recommendations and word of mouth to grow the product's customer base through the networks of its existing customers while establishing customer loyalty."
published: true
metaTags:
  - Harvest
...
- Setting up goals
  - If you decide to create a goal like referring X people, or earning Y points then it’s better to make that goal not look like a stretch and more of a direct approach. Being able to show and alert them to progress along the way is essential.
  ...
  - Use a breakeven point and a 10% conversion rate, calculate how many referrals your advocates would have to make to fuel your funnel.
