...
-	**Operational Cost:** Run cost estimations in operation including infrastructure and training. #CostBook
...
-	**Project Process:** Set of activities and the systematic process in which they need to be carried out to develop the product. This covers both engineering and delivery related disciplines. #DeliveryProcess
...
-	**Architecture Blueprint:** The architectural representation of the system's components. At the inception it could be the implementation of a feature vertical and the setup of the needed infrastructure to act as a guideline for further development. #TechArchitecture
