...
checklist: 
  -
    order: 1
    question: MI-Test-What is the unique message that you want to convey with your branding? 
    expectation: MI-Test-A simple but a powerful message that is instantly comprehendible.
    version: 1.1.0
  -
    order: 2
